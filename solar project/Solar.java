...
public class Solar extends JFrame 
{
	 ...
	 * Once an instance of the Solar class is created,
	 ...
	 */
	public Solar(int width, int height)
	{
		this.width = width;
		this.height = height;
	 ...
	 * The Solar class uses <i>Polar Co-ordinates</i> to represent the location
	...
	public void drawSolarObject(double distance, double angle, double diameter, String col)
	{
		...
		synchronized (this)
		{
			if (things.size() > 1000)
			{
				...
				System.out.println("to your Solar, then you have probably");
